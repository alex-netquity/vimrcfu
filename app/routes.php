...
Route::get('snippet/points', ['as' => 'snippets.points', 'uses' => 'SnippetsController@points']);
Route::get('snippet/comments', ['as' => 'snippets.comments', 'uses' => 'SnippetsController@comments']);
